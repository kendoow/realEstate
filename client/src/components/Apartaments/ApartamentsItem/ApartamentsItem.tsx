...
const ApartamentsItem: FC<ApartamentsItemProps> = ({ image,
    ...
    const { comments } = useTypedSelector(commentSelector)
            ...
            >
                ...
                <div className={styles.Text}>
                    ...
                    <h5 className={styles.Rating}>
                        Рейтинг - {rating}
                        <span>{commentsCount} отзыв{commentsCount > 1 && commentsCount < 5
                            ? <>a</>
                            : commentsCount !== 1 ? <>ов</> : null}</span>
                    </h5>
                    ...
                    <div className={styles.BtnBlock}>
                        ...
                        >
                            <svg width="20" height="23" viewBox="0 0 10 15" fill="#C9B087" xmlns="http://www.w3.org/2000/svg">
